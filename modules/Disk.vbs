...
Class Disk
	...
	Public Function Work (ComputerName, SelectedOptionsArray)
		...
		ResultArray = array()
			...
			Set CollectionItems = WMIService.ExecQuery("Select * from Win32_DiskDrive")
	...
	Public Sub List_Options
		...
		Set Localhost_CollectionItems = Localhost_WMIService.ExecQuery("Select * from Win32_DiskDrive")
